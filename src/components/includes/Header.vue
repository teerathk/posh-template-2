        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="left-top-info">
              <p>
                Optional - welcome msg will come here!
                <router-link to="signup">Join Free</router-link> or
          ...
          <div class="col-lg-6">
            ...
            <div class="head-right-info" v-if="isHidden">
              <div class="userLogined">
                <div class="usr-img">
                  <img
                    src="/src/assets/img/profile.6f7406c7.png"
                    class="proImg"
                  />
                </div>
          ...
          <div class="col-xl-3">
            <div class="top-area-contact-info pull-right">
              <div>
                Call Us Now:
                <span
                  ><a href="tel:0123444666" class="phone">0123-444-666</a></span
                >
              </div>
              <div>
                <span
                  ><a href="mailto:Contact@marketplace.com"
                    >Contact@marketplace.com</a
                  ></span
                >
              </div>
            </div>
